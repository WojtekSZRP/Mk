...
NCountry = {
	...
	LAND_FORCELIMIT_EXTRA_COST_FACTOR = 50,			-- extra expense for being above forcelimit
	NAVAL_FORCELIMIT_EXTRA_COST_FACTOR = 50,			-- extra expense for being above forcelimit
	...
	MAX_CROWN_COLONIES = 250,							-- How many province a country can hold in a colonial region before creating a colonial nation
...
NEconomy = {
	...
	COLONIST_TIME = 0.05,							-- _EDEF_COLONIST_TIME_
...
NMilitary = {
	...
	CAWA_STARTING_STRENGTH = 0.0,					-- Starting strength of a cawa regiment, 1.0 being full strength
	...
	JANISSARIES_STARTING_STRENGTH = 0,
	...
	CREATE_JANISSARIES_MIL_COST = 0,				-- Cost to create janissaries (per unit)
	CREATE_CAWA_MIL_COST = 0,						-- Cost to create Cawa (per unit)
